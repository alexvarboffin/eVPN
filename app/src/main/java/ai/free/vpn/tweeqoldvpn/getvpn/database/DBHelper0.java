...
//
//
//import static com.walhalla.vpnapp.repository.Constants.KEY_LON;
//
...
//
//public class DBHelper0 extends SQLiteOpenHelper implements ServerRepository {
//
...
//    private static DBHelper0 aa;
//
//
//    public DBHelper0(Context context) {
//        super(context, DATABASE_NAME, null, DATABASE_VERSION);
//    }
//
//    public static DBHelper0 newInstance(Context applicationContext) {
//        if (aa == null) {
//            aa = new DBHelper0(applicationContext);
//        }
//        return aa;
//    }
//
...
//                + KEY_QUALITY + " integer,"
//                + Constants.KEY_CITY + " text,"
//                + KEY_TYPE + " integer,"
//                + Constants.KEY_REGION_NAME + " text,"
...
//        contentValues.put(KEY_HOST_NAME, server.hostName);
...
//        contentValues.put(Constants.KEY_CITY, server.getCity());
//
...
//
//    @Override
//    public void getServersByCountryCode(String country, DataCallback<List<Server>> callback) {
...
//            db.close();
//        }
//        callback.successResult(serverList);
//    }
//
//    private Server parseGoodRandomServer(Cursor cursor, SQLiteDatabase db) {
//        List<Server> serverListExcellent = new ArrayList<>();
//        List<Server> serverListGood = new ArrayList<>();
//        List<Server> serverListBad = new ArrayList<>();
//
//        if (cursor.moveToFirst()) {
//            do {
...
//            ContentValues values = new ContentValues();
//            values.put(Constants.KEY_CITY, server.city);
//            values.put(Constants.KEY_REGION_NAME, server.regionName);
//            values.put(Constants.KEY_LAT, server.lat);
//            values.put(KEY_LON, server.lon);
//            db.update(TABLE_SERVERS, values, KEY_IP + " = ?", new String[]{server.getIp()});
//        }
//        db.close();
//    }
//
